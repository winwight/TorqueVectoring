###########################################################################
## Makefile generated for Simulink model 'DYC_controller'. 
## 
## Makefile     : DYC_controller.mk
## Generated on : Sun May 05 15:46:40 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DYC_controller.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/Heisenberg/Desktop/Cal_Poly/Graduate_Thesis_Research/Modeling/Vehicle_Model/SSIV_Deployment
ARCH                      = glnx
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DYC_controller.elf
...
DEFINES_STANDARD = -DMODEL=DYC_controller -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/raspberrypi/src/MW_SPI.c $(START_DIR)/DYC_controller_ert_rtw/DYC_controller.c $(START_DIR)/DYC_controller_ert_rtw/DYC_controller_data.c $(START_DIR)/DYC_controller_ert_rtw/rtGetInf.c $(START_DIR)/DYC_controller_ert_rtw/rtGetNaN.c $(START_DIR)/DYC_controller_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2018b/toolbox/realtime/targets/raspi/server/MW_raspi_init.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c

MAIN_SRC = $(START_DIR)/DYC_controller_ert_rtw/ert_main.c
...
OBJS = MW_SPI.c.o DYC_controller.c.o DYC_controller_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_raspi_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/DYC_controller_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/DYC_controller_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/DYC_controller_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
